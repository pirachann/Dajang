...
import com.example.dajang.ui.game.title.TitleFragmentDirections.ActionTitleFragment1ToGameFragment
    ...
    override fun onCreateView(
        ...
        binding.startBtn.setOnClickListener {view:View->
            if (binding.etName.text!!.isNotEmpty()){
                val action = TitleFragmentDirections.actionTitleFragment1ToGameFragment()
