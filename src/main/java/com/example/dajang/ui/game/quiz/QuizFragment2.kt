...
import com.example.dajang.data.Question
import com.example.dajang.databinding.FragmentQuizBinding

class QuizFragment2 : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View?
    {
        ...
        mQuestionsList = Question.getQuestion()
            ...
            R.id.btnSubmit->{
                ...
                if (mSelectedPosition == 0){
                    ...
                    when{
                        ...
                        // go to result
                        val action = QuizFragment2Directions.actionGameFragment2ToScoreFragment2()
                        val nameOfPlayer by navArgs<QuizFragment2Args>()
